...
<footer class="footer-distributed">
    <form name="newslettersignup" method="post">
			...
			<div class="footer-left">
				...
				<h3>SIGN UP FOR OUR NEWSLETTER.<span> <input type="text"> <input type="button" value="SignUp" class="myButton"></span></h3>

				<p class="footer-links">
					Get special offers and promotions right in your inbox.
				</p>

				<p class="footer-company-name">Amalya Reach &copy; 2015</p>
			</div>
			...
			<div class="footer-center">
				...
				<div>
					...
					<p><span>Homagama</span> Sri Lanka</p>
				</div>
